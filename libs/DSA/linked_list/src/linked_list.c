...
list_t * list_new(FREE_F free_func, CMP_F comp_func)
{
    ...
    if (NULL == new_list)
    {
        PRINT_DEBUG("list_new(): CMR failure.\n");
        goto END;
    }
...
int list_push_head(list_t * list, void * data)
{
    ...
    {
        PRINT_DEBUG("list_push_head(): NULL argument passed.\n");
    ...
    if (NULL == new_node)
    {
        PRINT_DEBUG("list_push_head(): Unable to create new node.\n");
        goto END;
    }
...
int list_push_tail(list_t * list, void * data)
{
    ...
    if ((NULL == list) || (NULL == data))
    {
        PRINT_DEBUG("list_push_tail(): NULL argument passed.\n");
        exit_code = E_NULL_POINTER;
        goto END;
    }
    ...
    if (NULL == new_node)
    {
        PRINT_DEBUG("list_push_tail(): Unable to create new node.\n");
        goto END;
    }
...
int list_push_position(list_t * list, void * data, uint32_t position)
{
    ...
    if ((NULL == list) || (NULL == data))
    {
        PRINT_DEBUG("list_push_position(): NULL argument passed.\n");
        exit_code = E_NULL_POINTER;
        goto END;
    }
    ...
    {
        PRINT_DEBUG("list_push_position(): Position out of bounds.\n");
        goto END;
    }
    ...
    if (NULL == new_node)
    {
        PRINT_DEBUG("list_push_position(): Unable to create new node.\n");
        goto END;
    }
...
int list_is_empty(list_t * list)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_is_empty(): NULL argument passed.\n");
        goto END;
    }
...
void * list_pop_head(list_t * list)
{
    ...
    {
        PRINT_DEBUG("list_pop_head(): List is empty.\n");
        goto END;
    }
...
void * list_pop_tail(list_t * list)
{
    ...
    {
        PRINT_DEBUG("list_pop_tail(): List is empty.\n");
        goto END;
    }
...
void * list_pop_position(list_t * list, uint32_t position)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_pop_position(): NULL argument passed.\n");
        goto END;
    }

    if (position >= list->size)
    {
        PRINT_DEBUG("list_pop_position(): Position out of bounds.\n");
        goto END;
    }
...
int list_remove_head(list_t * list)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_remove_head(): List is empty.\n");
        exit_code = E_NULL_POINTER;
        goto END;
    }
...
int list_remove_tail(list_t * list)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_remove_tail(): List is empty.\n");
        exit_code = E_NULL_POINTER;
        goto END;
    }
...
int list_remove_position(list_t * list, uint32_t position)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_remove_position(): List is empty.\n");
        exit_code = E_NULL_POINTER;
        goto END;
    }
    ...
    if (position >= list->size)
    {
        PRINT_DEBUG("list_remove_position(): Position out of bounds.\n");
        goto END;
    }
...
void * list_peek_head(list_t * list)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_peek_head(): NULL argument passed.\n");
        goto END;
    }

    if (NULL == list->head)
    {
        PRINT_DEBUG("list_peek_head(): Empty list.\n");
        goto END;
    }
...
void * list_peek_tail(list_t * list)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_peek_tail(): NULL argument passed.\n");
        goto END;
    }

    if (NULL == list->tail)
    {
        PRINT_DEBUG("list_peek_tail(): Empty list.\n");
        goto END;
    }
...
void * list_peek_position(list_t * list, uint32_t position)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_peek_position(): NULL argument passed.\n");
        goto END;
    }

    if (0 == list->size)
    {
        PRINT_DEBUG("list_peek_position(): Empty list.\n");
        goto END;
    }

    if (position >= list->size)
    {
        PRINT_DEBUG("list_peek_position(): Position out of bounds.\n");
        goto END;
    }
...
int list_remove_data(list_t * list, void * data_p)
{
    ...
    {
        PRINT_DEBUG("list_remove_data(): NULL argument passed.\n");
        exit_code = E_NULL_POINTER;
        goto END;
    }
    ...
    {
        PRINT_DEBUG("list_remove_data(): Node not found.\n");
        goto END;
    }
    ...
    {
        PRINT_DEBUG("list_remove_data(): Unable to remove node.\n");
        goto END;
    }
...
int list_foreach_call(list_t * list, ACT_F action_function)
{
    ...
    {
        PRINT_DEBUG("list_foreach_call(): NULL argument passed.\n");
        exit_code = E_NULL_POINTER;
        goto END;
    }
...
void * list_find_first_occurrence(list_t * list, void * search_data)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_find_first_occurrence(): NULL argument passed.\n");
        goto END;
    }
...
bool list_contains(list_t * list, void * data_p)
{
    ...
    if ((NULL == list) || (NULL == data_p))
    {
        PRINT_DEBUG("list_contains(): NULL argument passed.\n");
        goto END;
    }
...
void * list_pick_random_item(list_t * list)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_pick_random_item(): NULL argument passed.\n");
        goto END;
    }

    if (0 == list->size)
    {
        PRINT_DEBUG("list_pick_random_item(): List is empty.\n");
        goto END;
    }
    ...
    {
        PRINT_DEBUG("list_pick_random_item(): List size too large.\n");
        goto END;
    }
...
list_t * list_find_all_occurrences(list_t * list, void * search_data)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_find_all_occurrences(): NULL argument passed.\n");
        goto END;
    }

    if (0 == list->size)
    {
        PRINT_DEBUG("list_find_all_occurrences(): Empty list.\n");
        goto END;
    }
    ...
    {
        PRINT_DEBUG(
            "list_find_all_occurrences(): Unable to create new list.\n");
        goto END;
    }
    ...
    for (size_t idx = 0; idx < list->size; idx++)
    {
        if (EQUAL == (list->compare_func(search_data, current_node->data)))
        {
            ...
            {
                PRINT_DEBUG(
                    "list_find_all_occurrences(): Unable to push node into "
                    "list.\n");
...
int list_sort(list_t * list)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_sort(): NULL argument passed.\n");
        exit_code = E_NULL_POINTER;
        goto END;
    }
...
int list_clear(list_t * list)
{
    ...
    if (NULL == list)
    {
        PRINT_DEBUG("list_clear(): NULL argument passed.\n");
        exit_code = E_NULL_POINTER;
        goto END;
    }
...
int list_delete(list_t ** list_address)
{
    ...
    {
        PRINT_DEBUG("list_delete(): NULL argument passed.\n");
    ...
    if (E_SUCCESS != exit_code)
    {
        PRINT_DEBUG("list_delete(): Unable to clear list.\n");
        goto END;
    }
...
static list_node_t * list_node_new(void * data)
{
    ...
    if (NULL == data)
    {
        PRINT_DEBUG("list_node_new(): NULL argument passed.\n");
        goto END;
    }
    ...
    if (NULL == new_node)
    {
        PRINT_DEBUG("list_node_new(): CMR failure.\n");
        goto END;
    }
...
static list_node_t * find_node(list_t * list, void * data)
{
    ...
    if ((NULL == list) || (NULL == data))
    {
        PRINT_DEBUG("find_node(): Null argument passed.\n");
        goto END;
    }
...
static int remove_node(list_t * list, list_node_t * node)
{
    ...
    {
        PRINT_DEBUG("remove_node(): NULL argument passed.\n");
        exit_code = E_NULL_POINTER;
        goto END;
    }
